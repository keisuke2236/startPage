$(document).ready(function() {
  $(function() {
    ...
    var autor ="you";
    document.getElementById('div1').innerHTML = "Welcome ssc web site["+ autor +"]<br /> "+date.getFullYear()+"/"+(date.getMonth()+1)+"/"+date.getDate()+" ["+date.getHours()+":"+date.getMinutes()+"_"+date.getSeconds()+"]";
